...
DepthStencilStateDX11::DepthStencilStateDX11(ID3D11Device* pDevice)
	: m_pDevice(pDevice)
	  , m_bDirty(true)
{
	assert(pDevice);
...
D3D11_DEPTH_STENCIL_DESC DepthStencilStateDX11::TranslateDepthStencilState(
	const DepthMode& depthMode, const StencilMode& stencilMode) const
{

...
// 1D Texture
TextureDX11::TextureDX11(ID3D11Device* pDevice, uint16_t width, uint16_t slices, const TextureFormat& format, CPUAccess cpuAccess, bool bUAV)
	: m_pDevice(pDevice)
	, m_TextureWidth(0)
	, m_TextureHeight(1)
	, m_TextureResourceFormatSupport(0)
...
// 2D Texture
TextureDX11::TextureDX11(ID3D11Device* pDevice, uint16_t width, uint16_t height, uint16_t slices, const TextureFormat& format, CPUAccess cpuAccess, bool bUAV)
	: m_pDevice(pDevice)
...
// CUBE Texture
TextureDX11::TextureDX11(CubeCtor, ID3D11Device* pDevice, uint16_t size, uint16_t count, const TextureFormat& format, CPUAccess cpuAccess, bool bUAV)
{
...
uint8_t Hikari::TextureDX11::GetBpp() const
{
	return m_BPP;
}

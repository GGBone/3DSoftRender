...
namespace Hikari
{
	...
	public:
		...
		void SetAttribute(int attribute, unsigned int streamIndex, unsigned int offset, AttributeType, AttributeUsage,
	...
	inline unsigned int VertexFormat::GetStreamIndex(int attribute)
	{
	...
	inline VertexFormat::AttributeType VertexFormat::GetAttributeType(int attribute) const
	{
		return mElements[attribute].Type;
	}

	inline VertexFormat::AttributeUsage VertexFormat::GetAttributeUsage(int attribute) const
	{

...
bool Triangles::GetModelTriangle(int i, APoint* modelTrangle) const
{
	int v0, v1, v2;
...
bool Triangles::GetWorldTrangle(int i, APoint* worldTrangle) const
{
...
Float3 Triangles::GetPoistion(int v) const
{
...
AVector Triangles::ComputeTangent(const APoint& position0, const Float2& tcoord0, const APoint& position1,
                                  const Float2& tcoord1, const APoint& position2, const Float2& tcoord2)
{
	return AVector();
}

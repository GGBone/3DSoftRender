...
namespace Hikari
{
	...
	public:
		...
		inline const char* GetWindowTitle()const { return mWindowTitle.c_str(); }
		inline int GetXPosition()const { return mYPosition; }
		inline int GetYPosition()const { return mXPosition; }
		inline int GetWidth()const { return mWidth; }
		inline int GetHeight()const { return mHeight; }
		inline void SetWidth(int width) { mWidth = width; }
		inline void SetHeight(int height) { mHeight = height; }
		inline float GetAspectRatio()const { return 0.0f; }
		inline void SetWindowID(int windowID) { mWindowID = windowID; }
		inline int GetWindowID()const { return mWindowID; }
